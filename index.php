        ...
        <table>
            <tr valign="top">
                ...
                <td style="vertical-align: top; text-align: left;">
                    ...
                    <div class="fb-like" data-href="http://www.ees-uai.com.ar/" data-send="true" data-layout="box_count"
                         data-width="200px" data-show-faces="true"></div>
                    <div id="fb-root"></div>
                    <script>(function (d, s, id) {
                            var js, fjs = d.getElementsByTagName(s)[0];
                            if (d.getElementById(id)) {
                    ...
                    <div class="fb-facepile" data-href="http://www.ees-uai.com.ar/" data-width="200px"
                         data-max-rows="1"></div>
                </td>
            </tr>
            <tr>
