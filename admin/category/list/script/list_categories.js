...
$(document).ready(function() 
{
	...
	function ChangeStatus(category_id,status)
	{
		...
		var value = confirm("¿Esta seguro de Habilitar o Desabilitar esta Categoría (Habilita o Desabilita la Categoría para poder ser utilizada en la creación de Noticias)?");
		if(value == true)
		{
			$.getJSON(url, function(data) 
			{	
